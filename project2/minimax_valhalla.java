...
public class minimax_valhalla extends AIModule
{
	...
	public void getNextMove(final GameStateModule state)
	{
		...
		chosenMove = iterativeMinimaxDecision(state);
	}

	/**
	* @return the chosenMove
	*/
	public int iterativeMinimaxDecision(final GameStateModule state)
	{
	...
	public int maxValue(final GameStateModule state, int depth)
	{
	...
	public int minValue(final GameStateModule state, int depth)
	{
		//if terminate that means the time limit is about up so return
		if (state.isGameOver() || terminate || depth <= 0)
		{
